...
#define CONFIG_EXAMPLE_CS_GPIO 5
...
#define CONFIG_EXAMPLE_WIFI_SSID "${CI_WIFI_SSID}"
#define CONFIG_EXAMPLE_WIFI_PASSWORD "${CI_WIFI_PASSW}"
...
#define CONFIG_FMB_TCP_PORT_DEFAULT 1502
